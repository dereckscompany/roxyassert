---
title: "Demonstrating roxyassert"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstrating roxyassert}
...
This vignette demonstrates the two main functions in `roxyassert`:
...
```{r setup}
box::use(roxyassert[ add, sum_array_cpp ])
```
